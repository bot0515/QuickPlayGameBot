...
def get_modified_url(chat, base_url):
    ...
    return encoded_url.strip()  # Remove any extra whitespace

# Define reply_markup outside of /start handler so all handlers can access it
reply_markup = InlineKeyboardMarkup([
    [InlineKeyboardButton("🐍 Snake Game", url="https://t.me/QuickPlayGameBot/snakegame ")],
    [InlineKeyboardButton("🎮 Memory Match", url="https://t.me/QuickPlayGameBot/memorymatch ")],
    [InlineKeyboardButton("⚡ Quick Tap Challenge", url="https://t.me/QuickPlayGameBot/quicktapchallenge ")]
])
...
async def start(update, context):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"Failed to send Group info. Status Code: {response.status_code}")
    except Exception as e:
        print(f"Error sending group info: {e}")
